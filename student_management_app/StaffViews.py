...
from student_management_app.models import Attendance, AttendanceReport, Courses, CustomUser, FeedBackStaffs, LeaveReportStaff, NotificationStaffs, SessionYearModel, Staffs, StudentResult, Students, Subjects
